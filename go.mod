...
replace (
	...
	github.com/openshift/api => github.com/openshift/api v0.0.0-20251124235416-c11dd82e305c
	github.com/openshift/client-go => github.com/openshift/client-go v0.0.0-20251123231646-4685125c2287

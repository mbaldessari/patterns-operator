...
require github.com/argoproj/argo-cd/v2 v2.12.3
...
replace (
	...
	github.com/argoproj/gitops-engine => github.com/argoproj/gitops-engine v0.7.1-0.20250521000818-c08b0a72c1f1
